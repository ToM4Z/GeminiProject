...
public static class GlobalVariables
{
    ...
    public static readonly string[] Dialogues = new string[]
    {
        ...
        "Record ottenuto: ", "Vedi di fare di meglio!!",

        // [2, 7] Hub, D1 all'inizio della partita
        "Stupido Timmy, ti mando ad esplorare nuove dimensioni al posto mio e la prima cosa che fai è rompere l'astronave!!",
        "Per poter tornare qui e farti resettare, devi trovare tutti i componenti sparsi in giro e portarli qui.",
        "Perfino tu non dovresti avere difficoltà, tanto per muoverti devi usare WASD o l'analogico sinistro.",
        ...
        "Stupido Timmy, devi accovacciarti con C o il tasto B del JoyPad per poter entrare in quel tubo.",
        ...
        "Non verrò di certo io a prenderti!",
        "Buona permanenza!!",
        ...
        "Dannazione, ma che razza di mondo è questo?!",
        "Per proseguire dovrai saltare... Premi SPAZIO o il tasto A del Joypad.",
        "Effettivamente potevo montarti dei razzi sotto i piedi, ma mi servivano i pezzi per la macchinetta del caffè...",

        // [19, 20] Level 1, D5, davanti il BonusBlock
        "Ehi, quella è una cassa Bonus!",
        "Attivala saltandoci di sotto per ottenere ingranaggi extra!",

        // [21, 21] Level 1, D6, davanti il muro distruggibile
        "Mmm... quel muro sembra fragile... Li vicino c'è una bomba, usa il tasto E, o Y del Joypad, per piazzarla e distruggere quel muro.",

        // [22, 25] Level 1, D7, davanti al fungo
        "I tuoi radar mi segnalano che qui sopra c'è molta attività... ti consiglio di prepararti!",
        ...
        "Hai trovato una vita! Vabbe è inutile tanto morirai comunque miseramente...",
